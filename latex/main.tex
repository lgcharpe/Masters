...
\chapter{Single Layer ANN}
    ...
    \section{Pruning Nodes at Random}
        ...
        \begin{algorithm}
            \SetKwFunction{RemRndN}{remove_random_nodes}
            ...
            \Fn{\RemRndN{n, weights, to_consider}}{
                \KwIn{n is the number of nodes removed; \\ weights are the weights of the model; \\ to_consider is an
                araay containing the nodes to consider in the random choosing}
                \
            }
        \end{algorithm}
